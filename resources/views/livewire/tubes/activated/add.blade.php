<div>
    <div class="col-sm-12 text-right">
        <x-adminlte-button class="btn-xs" wire:click="$emitUp('cancelAddData')" label="<< back" theme="danger" />
    </div>
    <br>
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <b>RENEWAL</b> || Add Data
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12 text-left">
                        <x-adminlte-button wire:click="saveData" theme="success" icon="fa fa-save" class="btn btn-sm"
                            label="Save" />
                    </div>
                </div>
            </div>
